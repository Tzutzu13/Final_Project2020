...
def ReadingAudioExcel(path):
    ...
    xl_workbook = xlrd.open_workbook(r"" +path + "/gold standars.xlsx")
    ...
    for row_idx in range(1, num_rows): # Iterate through rows
        ...
        data_folder = Path(path + "/Recordings/%s relevant/%s/ch1" %(current_row[2], current_row[1]))
